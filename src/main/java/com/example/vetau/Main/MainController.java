...
public class MainController {
    ...
    @FXML
    private TextField signup_congviec;
    ...
    public void signup() throws SQLException {
        ...
        String sql = "INSERT INTO account (idAccount, accountname, password, Name, CCCD, Congviec,Address,date,Email)" +" VALUES (?,?,?,?,?,?,?,?,?)";
        ...
        Alert alert;
        try {
            String sql_check_have = "SElECT * FROM account WHERE accountname = ? and CCCD = ?";
            PreparedStatement check_have = connection.prepareStatement(sql_check_have);
            check_have.setString(1,signup_usename.getText());
            check_have.setString(2,signup_cccd.getText());
        ...
        try{
            resultSet = statement.executeQuery("SELECT COUNT(*) AS total FROM account");
            if(resultSet.next())
            {
            ...
            preparedStatement.setString(1,"Acc" + (totalCount + 1));
            preparedStatement.setString(2,signup_usename.getText());
            preparedStatement.setString(3,pass);
            preparedStatement.setString(4,signup_name.getText());
            preparedStatement.setString(5,signup_cccd.getText());
            preparedStatement.setString(6,signup_congviec.getText());
            preparedStatement.setString(7,signup_address.getText());
            preparedStatement.setDate(8,java.sql.Date.valueOf(signup_date.getValue()));
            preparedStatement.setString(9,signup_email.getText());
            ...
            }else if (!ValidEmail(signup_email.getText()))
            {
                    ...
                    ||signup_cccd.getText().isEmpty()||signup_congviec.getText().isEmpty()||signup_usename.getText().isEmpty()){
                alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Error Message");
